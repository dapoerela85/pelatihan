...
async function loadQuestions(id) {
  try {
    const response = await fetch(`../questions../modul/${id}.json`);
    ...
    notFoundContainer.innerHTML = `
        <div class="card shadow">
            <div class="card-body">
                ...
                <a href="../modul/" class="btn btn-primary mt-3">
    ...
    const faqItems = [
        {
            ...
            answer: "Dihalaman <a href='../modul/'>utama/beranda</a>, pilih ujian yang ingin dikerjakan dan akan dialihkan kehalaman ujian, Klik tombol 'Mulai Sekarang' untuk memulai ujian."
        },
        {
...
function setupNotificationEventListeners() {
  ...
  document.querySelectorAll('.continue-quiz-btn').forEach(btn => {
    btn.addEventListener('click', function() {
      ...
      window.location.href = `../modul/?id=${quizId}&soal=${questionNum}`;
    });
  });
